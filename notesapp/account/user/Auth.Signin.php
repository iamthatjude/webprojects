                    ...
                    <div class="col-md-5 col-sm-12 col-12 align-self-center">
                        <div class="sign-user_card" id="auth">
                            ...
                            <form v-on:submit.prevent>
                                ...
                                <button type="submit" class="btn btn-primary" id="btnSignin" @click="checkFields('login', 'user')">Sign In</button>
                                <p class="mt-3 mb-0">
                                    Create an Account <a href="<?= USER_SIGNUP; ?>" class="text-primary"><b>Sign Up</b></a>
                                </p>
                            </form>
